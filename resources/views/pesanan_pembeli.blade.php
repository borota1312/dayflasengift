...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">CEK PESANAN</h3>
    <div class="card p-5 mb-5">
      <form method="POST" action="pesanan.php" enctype="multipart/form-data">
      <div class="form-group">
          <label for="kode1">Kode Pesanan</label>
          <input type="text" class="form-control" id="Kode1" name="Kode"   value="1234">
        </div>  
      <div class="form-group">
          <label for="menu1">Status</label>
       ...
       <br>
        <button type="submit" class="btn btn-primary" name="tambah" href="pesanan" >CEK</button>
